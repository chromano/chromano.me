...
I ran it again, no luck, still hanging. WTF? After a lot of attempts, debugging and mainly "research":http://code.activestate.com/recipes/186101-really-closing-stdin-stdout-stderr/, I finally found the culprit => python! (really?).
...
Anyways, it is worth to give "python-daemon":http://pypi.python.org/pypi/python-daemon a try.