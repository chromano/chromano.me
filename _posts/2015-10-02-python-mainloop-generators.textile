...
Right. But what happens when you've got two or more generators? Well, you could write your code specifically for consuming one iteration at time by using <code>next()</code> calls, but that's kind of... boring.
